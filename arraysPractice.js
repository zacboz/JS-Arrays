...
function divider(numbersArray) {
  ...
  for (var i = 0; i < numbersArray.length; i++) {
    if (numbersArray[i] % 2 === 0) {
      evensOddsArray[0].push(numbersArray[i]);
    } else {
      evensOddsArray[1].push(numbersArray[i]);
    }
...
var user2 = {
    name: 'Zach Boswell',
    email: 'zachboswell@gmail.com',
    password: 'iloveskyrim',
    username: 'zacboz'
};

var user3 = {
    name: 'Zac Boswell',
    email: 'zacboswell@gmail.com',
    password: 'ilovedestiny',
    username: 'zacboz17'
};
